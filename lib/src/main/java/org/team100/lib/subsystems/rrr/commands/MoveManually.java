...
public class MoveManually extends Command {
    ...
    public MoveManually(RRRArm arm, XboxController controller) {
        m_arm = arm;
    ...
    public void execute() {
        ...
        double q1dot = -1.0 * m_controller.getLeftX(); // axis 0
        double q2dot = m_controller.getRightX(); // axis 4
        double q3dot = m_controller.getRightY(); // axis 5
