...
public class Binder {
    ...
    public Binder(Machinery machinery) {
        ...
        // button 4, "v" in sim
        // tool (x) pointing +x
        MoveAndHold move1 = m_machinery.m_arm.move(new Pose3d(0.5, 0.25, 0.1, new Rotation3d(0, Math.PI / 2, 0)));
        MoveAndHold move2 = m_machinery.m_arm.move(new Pose3d(0.25, 0.25, 0.1, new Rotation3d(0, Math.PI / 2, 0)));
        MoveAndHold move3 = m_machinery.m_arm.move(new Pose3d(0.25, -0.25, 0.1, new Rotation3d(0, Math.PI / 2, 0)));
        MoveAndHold move4 = m_machinery.m_arm.move(new Pose3d(0.5, -0.25, 0.1, new Rotation3d(0, Math.PI / 2, 0)));
